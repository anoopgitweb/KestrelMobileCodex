    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(
                    text = "Configure your Supabase Project URL and public anon key to authenticate users directly via Supabase Auth and database tables.",
                ...
                Surface(
                    ...
                    Row(
                        ...
                        Spacer(modifier = Modifier.width(8.dp))
                        Text(
                            text = "Even without an active Supabase project, offline admin approval & role gating are fully operational.",
